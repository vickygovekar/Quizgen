...
<body>
<?php 
  $active_page = "student"; // Define the active page variable
...
<div class="container">
	<div class="option-box">
			...
			<p>Easily display stored question with filters</p>
			<button class="button"><a href="../teacher/display.php">Open</a></button>
		</div>
	</div>
</div>
</div>	
